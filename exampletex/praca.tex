...
% paczka do obracania figur (tak jej uzylem). Powoduje to ze mozna dac figure sideways
\usepackage{lscape}
\usepackage{chngpage}
...
\titlePL{Aplikacja internetowa do nauki języka obcego}
\titleEN{Internet application for foreign language learning}

% Skrócone wersje tytułów po polsku/angielsku
% wyświetlane np. gdy normalne są bardzo długie
\shorttitlePL{Aplikacja internetowa do nauki języka}
\shorttitleEN{Internet application for language learning}
